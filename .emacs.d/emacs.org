...
** Org-Reveal-js
   ...
   #+BEGIN_SRC emacs-lisp :tangle yes
     (add-to-list 'load-path "~/.emacs.d/src/org-reveal")
     (require 'ox-reveal)
     (setq org-reveal-root
           (concat "file://"
                   (expand-file-name "~/.emacs.d/src/reveal.js")))
   #+END_SRC
...
** CMake-IDE
   ...
   #+BEGIN_SRC emacs-lisp :tangle yes
     ...
     (add-to-list 'load-path "~/.emacs.d/src/cmake-ide")
     ;; (require 'rtags)
     (require 'cmake-ide)
     (cmake-ide-setup)
...
* Lua
  #+NAME: emacs-lua
  #+BEGIN_SRC emacs-lisp :tangle yes
    (add-to-list 'load-path "~/.emacs.d/src/lua-mode")
    (require 'lua-mode)
